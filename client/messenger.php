<div id="messenger" class="container-fluid__messenger messenger jumbotron p-0 shadow">
    <div id="messengerHeader" class="messenger__header p-0 rounded-top bg-secondary">
        ...
        <div id="messageSender" class="d-inline-block">
            Manager <span class="text-warning">vlad99</span>
            <div class="text-light">Online</div>
        </div>
    </div>
    <div id="messengerBody" class="messenger__body">
        <div id="messengerBody" class="messages overflow-auto bg-dark p-2">
            <div id="receiveMessageBlock" class="message-wrap">
                <div class="send-message text-break text-left jumbotron d-inline-block m-1 p-1 bg-secondary">Hello!
                </div>
            </div>
            ...
            <div class="message-wrap">
                <div class="send-message text-break text-left jumbotron d-inline-block m-1 p-1 bg-secondary">Can I help
                    you?
                </div>
            </div>
            <div class="message-wrap">
            ...
            <div class="message-wrap">
                <div class="receive-message text-break text-right jumbotron float-right d-inline-block m-1 p-1 bg-secondary">
                    Please tell me how your bank client management works? I don't understand how to manage my client
                    menu!
                </div>
            </div>
            <div class="message-wrap">
                <div class="send-message text-break text-left jumbotron d-inline-block m-1 p-1 bg-secondary">Ok, just a
                    minute...
                </div>
            </div>
            <div class="message-wrap">
    ...
    <div id="messengerFooter" class="messenger__footer p-2">
        <form action=""
            ...
            <div class="paperclip d-inline-block"><img src="../img/messanger/smile.svg" class="paperclip-img"
                                                       alt="Smiles"></div>
